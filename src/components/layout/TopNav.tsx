    ...
    <header className="h-12 bg-[#161b22] border-b border-[#30363d] px-4 flex items-center justify-between z-30 select-none text-xs">
      ...
      <div className="flex-1 max-w-sm mx-4 hidden md:block">
        <button
          ...
          className="w-full flex items-center justify-between px-3 py-1.5 rounded-lg bg-[#0d1117] hover:bg-[#21262d] border border-[#30363d] text-slate-400 text-xs transition-all group"
        >
          ...
          <kbd className="px-1.5 py-0.2 rounded bg-[#161b22] border border-[#30363d] text-[10px] font-mono text-slate-400">
            ⌘K
          </kbd>
        </button>
      </div>
